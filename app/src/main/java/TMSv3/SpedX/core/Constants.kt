...
object Constants {
    ...
    const val ETOLL_SCREEN = "Dane eToll"
    const val VINIET_SCREEN = "Dane SMSvinjetes"
    const val ASN_SCREEN = "Dane AutoSatNet"
    const val PUESC_SCREEN = "Dane PUESC"
    const val SETTINGS_SCREEN = "Ustawienia"
